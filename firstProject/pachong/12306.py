...
def get_check():
    url = 'https://kyfw.12306.cn/otn/leftTicket/queryZ?leftTicketDTO.train_date=2018-02-01&leftTicketDTO.from_station=WXH&leftTicketDTO.to_station=AQH&purpose_codes=ADULT'
